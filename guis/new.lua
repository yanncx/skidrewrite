...
scarcitybanner.Text = 'Ty for using Genv private your cool!'
...
general:CreateButton({
	...
	mainapi.Save = function() end
		...
		if shared.VapeDeveloper then
			...
			loadstring(game:HttpGet('https://raw.githubusercontent.com/skidrewrite/skidrewrite/'..readfile('newvape/profiles/commit.txt')..'/loader.lua', true))()
		end
	end,
